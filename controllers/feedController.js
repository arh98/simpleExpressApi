...
module.exports = {
    ...
    createPost: (req, res, next) => {
        ...
        post.save()
            ...
            .then((user) => {
                ...
                // on the client after openning socket:
                // socket.on('posts', data => {work with data.action , data.post})
                // if(data.action === 'X') this.loadPosts() or this.addPost(data.post)
    ...
    updatePost: async (req, res, next) => {
        ...
        try {
            ...
            io.getIO().emit('posts', { action: 'update', result: result });
